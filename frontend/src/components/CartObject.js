...
const CartObject = ({ ainaYaKipimo }) => {
    const [idadiYaNdiziZilizochaguliwa, setIdadiNdiziZilizochaguliwa] =
        useState(0); // idadi ya ndizi ya ndizi zilizochaguliwa kulingana na kipimo ( mkungu au kichane )
            ...
            <View style={{ flex: 1 }}>
                <View>
                    ...
                    <Text style={{ marginBottom: 5 }}>
                        {kipimo} - {idadiYaNdiziZilizochaguliwa}
                    </Text>
                </View>
                <View
                    style={{
                ...
                >
                    <View style={{ flexDirection: "row" }}>
                        ...
                        >
                            <AntDesign name="plus" size={24} color="#f3fff3" />
                        </TouchableOpacity>
                        <View
                            style={[
                                styles.boxes,
                        ...
                        >
                            <Text>{idadiYaNdiziZilizochaguliwa}</Text>
                        </View>
                        <TouchableOpacity
                            activeOpacity={0.7}
                            onPress={handleAmountUpdateSub}
                            style={[
                                styles.boxes,
                                styles.aligner,
                                { backgroundColor: "red" },
                        ...
                        >
                            <AntDesign name="minus" size={24} color="#f3fff3" />
                        </TouchableOpacity>
                    </View>
